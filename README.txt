...
- Jakarta Ant (versions 1.6.2 and higher - I have not tried using older versions, so please inform me if you find that they work as well). You may install it from http://ant.apache.org. This is used to run the build scripts in order to compile the source files.
